...
class PegasusApp:
    ...
    def __init__(self):
        ...
        for i in range(3):
            self.vehicle_factory(i, gap_x_axis=0.0, gap_y_axis=10.0)
    ...
    def vehicle_factory(self, vehicle_id: int, gap_x_axis: float, gap_y_axis: float):
        ...
        ros2_backend = ROS2Backend(vehicle_id=vehicle_id+1,
                                   config={'namespace':'drone',
                                           'pub_sensors':True,
        ...
        Multirotor(
            ...
            ROBOTS['Iris'],
            vehicle_id + 1,
            [gap_x_axis * vehicle_id, gap_y_axis * vehicle_id , 0.0],
